...
.outer-div-inner table thead {
  ...
  <body style="background-color:#ecf0f5;margin:0;padding:3rem 0;font-size:15px;font-family: 'Lato', sans-serif;">
<!-- Main content -->
...
<div class="row">
<div class="col-md-4"><p class="m-0">Invoice No:<b> CLDI0007 </b></p></div>
<div class="col-md-4 text-center"><h1>Invoice</h1></div>
<div class="col-md-4 text-right"><p class="m-0">Invoice Date:<b> 26 June 2019</b></p></div>
</div>
<div class="row mt-5">
<div class="col-md-8">
<h3>To</h3>
