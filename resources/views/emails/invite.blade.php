                     ...
                     <tr>
                        <td align="left" valign="top">
                           ...
                           <table class="mob_btn" cellpadding="0" cellspacing="0" border="0" style="background: green; border-radius: 4px;">
                              <tr>
                                 <td align="center" valign="top"> 
                                    <a href="{{ route('accept', $token) }}" target="_blank" style="display: block; border: 1px solid green; border-radius: 4px; padding: 12px 23px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                              ...
                              <tr>
                                 <td> 
                                    <span style="font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #333; font-size: 17px; line-height: 30px;">If button does not work click on below link:-<br>
                                       <a href="http://buildatwill.com/cloud/public/accept/{{$token}}">http://buildatwill.com/cloud/public/accept/{{$token}}</a></span>
                                 </td>
                              </tr>
                           </table>
