                     ...
                     <tr>
                        <td align="left" valign="top">
                           ...
                           <font>
                              ...
                              <span style="color:#333;font-size:23px;font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif;font-weight:600;">for Signing Up</span>
                           </font>
                           <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                           <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 24px; line-height: 32px;">
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">To activate your account click below button.</span>
                           </font>
                           <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                           <table class="mob_btn" cellpadding="0" cellspacing="0" border="0" style="background: green; border-radius: 4px;">
                              <tr>
                                 <td align="center" valign="top"> 
                                    <a href="{{ route('acceptClient', $token) }}" target="_blank" style="display: block; border: 1px solid green; border-radius: 4px; padding: 12px 23px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                           ...
                           <table style="margin-top:40px;">
                              <tr>
                                 <td> 
                                    <span style="font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #333; font-size: 17px; line-height: 30px;">If button does not work click on below link:-<br>
                                       <a href="http://buildatwill.com/cloud/public/accept/Client/{{$token}}">http://buildatwill.com/cloud/public/accept/Client/{{$token}}</a></span>
                                 </td>
                              </tr>
                           </table>
