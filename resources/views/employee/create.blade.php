	...
	<div class="container">
		<div class="card-body">
			<form action="" method='post'>
				@csrf
				<div class="text-center"><h4>{{"Personal Inforamtion"}}</h4></div>
				<div class="row">
					<div class="col-md-4">
				...
				<div class="text-center"><h4>{{"Contact Information"}}</h4></div>
				<div class="row">
					<div class="col-md-4">
					<div class="form-group">
				...
				<div class="text-center"><h4>{{"Professional Information"}}</h4></div>
				<div class="row">
					<div class="col-md-4">
					<div class="form-group">
				...
				<div class="text-center"><h4>{{"Emergency Contact Information"}}</h4></div>
				<div class="row">
					<div class="col-md-6">
					<div class="form-group">
				...
				<div class="text-center"><h4>{{"Account Information"}}</h4></div>
				<div class="row">
					<div class="col-md-6">
					<div class="form-group">
