 ...
 <div class="container">
  <div class="row">
   <div class="col-md-4 col-md-offset-4 authentication-form-wrapper">
    ...
    <div class="row">
      @if($wage=='No')
      <form action="{{route('log.login',['id'=>$id])}}" method="post">
        @csrf
        <div class="text-center">
        <a class="text-center"><button class="btn btn-success" value="gf" type="submit">Login</button></a>
        </div>
      </form>
      @else
      <div class="text-center">
        <a href="{{route('log.logout',['id'=>$wage->id])}}" class="btn btn-danger">Logout</a>
      </div>
      @endif
    </div>
</div>
