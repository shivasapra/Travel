...
<form action="{{route('lead.convert')}}" method="post" enctype="multipart/form-data" name="myForm">
    @csrf
        <input type="text" name="lead_id" value="{{$id}}" hidden>
		...
		<div class="box-body">
				...
				<div class="row">
					...
					<div class="form-group">
						...
						<input type="date" name='DOB' value="{{$lead->DOB}}" required class="form-control">
					</div>
                    </div>
                    <div class="col-md-3">
                    <div class="form-group">
